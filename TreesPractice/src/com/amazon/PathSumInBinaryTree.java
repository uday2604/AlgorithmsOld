 ...
 * Return if the tree contains a path from the root to leaf where the sum of its nodes is equal to passed value - iterative approach
 * TODO: think of recursive / memory optimized approach
 */
public class PathSumInBinaryTree {
    ...
    private boolean sumPathExistsFromRootToLeaf(BinaryTreeNode root, int sumValue) {
        if (root == null)
            return false;
        else {
