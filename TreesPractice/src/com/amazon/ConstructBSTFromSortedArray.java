...
public class ConstructBSTFromSortedArray {
    ...
    private static BinaryTreeNode constructBSTFromArray(Integer[] sortedArray) {
        return constructTreeHelper(sortedArray, 0, sortedArray.length - 1);
    }

    private static BinaryTreeNode constructTreeHelper(Integer[] inputSortedArray, int start, int end) {
    ...
    private static BSTNode constructBST(BSTNode root, int insertData) {
        if (root == null)
