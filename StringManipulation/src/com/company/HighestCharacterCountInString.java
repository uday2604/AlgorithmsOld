 ...
 * Get the highest character count and the character
 */
public class HighestCharacterCountInString {

    private List<Character> countOfHighestCharacters(String inputString) {
    ...
    private Character getMaxCount(String inputString) {
