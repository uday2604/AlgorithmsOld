...
/**
 * Created by udaypersonal on 9/27/16.
 */
public class IntegerToAlphabets {
    ...
    public static void main (String[] args) {
        IntegerToAlphabets integerToAlphabets = new IntegerToAlphabets();
        System.out.println(integerToAlphabets.numberToWords(1553));
